 ...
 * @author CC
 */
public class ListMaisonForm extends BaseForm {
    
    
     Form current;
    public ListMaisonForm(Resources res ) {
          super("Newsfeed",BoxLayout.y()); //herigate men Newsfeed w l formulaire vertical
        Toolbar tb = new Toolbar(true);
        current = this ;
        setToolbar(tb);
        getTitleArea().setUIID("Container");
        setTitle("Listes des Maison d'hotes ");
      ...
      ButtonGroup barGroup = new ButtonGroup();
        RadioButton mesListes = RadioButton.createToggle(" Maisons ", barGroup);
     ...
     //     MapsAPIForm a1 = new MapsAPIForm();
       ...
       //    a1.show();
        ...
        ArrayList<Maison>list = ServiceMaison.getInstance().affichageMaison();
    ...
    private void addButton(Image img,Maison m , Resources res) {
        ...
        Label localisationTxt = new Label("localisation : "+m.getLocalisation(),"NewsTopLine2");
        Label descriptionTxt = new Label("description : "+m.getDescription(),"NewsTopLine2");
        Label prixTxt = new Label("prix : "+m.getPrix(),"NewsTopLine2");
        Label imageMaisonTxt = new Label("moyen de transport : "+m.getImageMaison(),"NewsTopLine2");
       ...
       */
       ...
       //supprimer button
        ...
        lSupprimer.addPointerPressedListener(l -> {
            ...
            if(dig.show("Suppression","Vous voulez supprimer cette  maison ?","Annuler","Oui")) {
                dig.dispose();
            }
            else {
                dig.dispose();
                 }
                if(ServiceMaison.getInstance().deleteMaison(m.getIdMaison())) {
       ...
       Label lModifier = new Label(" ");
        ...
        lModifier.addPointerPressedListener(l -> {
            ...
            new ModifierMaisonForm(res,m).show();
        });

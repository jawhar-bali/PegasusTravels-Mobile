...
public class ListVoyageForm extends BaseForm  {
    ...
    public ListVoyageForm(Resources res ) {
        ...
        addTab(swipe,s1, res.getImage("paris.jpg"),"","",res);
      ...
      //  System.out.println("user connecté email ="+ SessionManager.getEmail());
        ...
        RadioButton mesListes = RadioButton.createToggle("Mes Voyages", barGroup);
        ...
        final Dialog ipDlg = ip.showInifiniteBlocking();
         ...
         ListVoyageForm v = new ListVoyageForm(res);
          v.show();
            refreshTheme();
        });
        ...
        final Dialog ipDlg = ip.showInifiniteBlocking();
          ...
          StatistiquePieFormV a2 = new StatistiquePieFormV(res);
           a2.show();
        ...
        add(LayeredLayout.encloseIn(
                GridLayout.encloseIn(4, mesListes, liste, partage,stat),
        ...
        ArrayList<Voyage>list = ServiceVoyage.getInstance().affichageVoyage();
    ...
    private void addButton(Image img,Voyage v , Resources res) {
        ...
        Label nomTxt = new Label("nom : "+v.getNom(),"NewsTopLine2");
        Label localisationTxt = new Label("destination : "+v.getDestination(),"NewsTopLine2");
        Label descriptionTxt = new Label("description : "+v.getDescription(),"NewsTopLine2");
        Label prixTxt = new Label("prix : "+v.getPrix(),"NewsTopLine2");
        Label imageTxt = new Label("compagnie aérienne : "+v.getImage(),"NewsTopLine2");
       ...
       */ //supprimer button
        ...
        lSupprimer.addPointerPressedListener(l -> {
            ...
            if(dig.show("Suppression","Vous voulez supprimer ce voyage ?","Annuler","Oui")) {
                ...
                if(ServiceVoyage.getInstance().deleteVoyage(v.getId())) {
       ...
       Label lModifier = new Label(" ");
        ...
        lModifier.addPointerPressedListener(l -> {
            ...
            new ModifierVoyageForm(res,v).show();
        });

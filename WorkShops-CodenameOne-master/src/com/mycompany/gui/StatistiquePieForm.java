...
public class StatistiquePieForm extends Form {
    ...
    private double nbr_reservation = 0.001;
    private double nbr_voyage = 0.005;
    ...
    Form current;
     ...
     //   setTitle("Acceuill");
      ...
      //  RadioButton popular = RadioButton.createToggle("Categorie Voyage", barGroup);
      //  popular.setUIID("SelectBar");
      //  RadioButton feedback = RadioButton.createToggle("Feedback", barGroup);
      //  feedback.setUIID("SelectBar");
        RadioButton profile = RadioButton.createToggle("Return", barGroup);
  ...
  ;       
    ...
    public void createPieChartForm() {
       ...
       double total = nbr_reservation+ nbr_voyage;
        
        //values
        double prcntFeed = (nbr_reservation *100)/total;
        
        double prcntRec = (nbr_voyage * 100)/total;
        ...
        String []messages = {
            "Statistique nbre des reservations par rapport à des maisons"
        };
    ...
    private CategorySeries buildDataset(String title, double prcntFeed, double prcntRec) {
        ...
        series.add("Maison",prcntRec);
        series.add("Reservation",prcntFeed);
       //  series.add("Evenements>50$",prcntRec);
      //  series.add("Evenements<50$",prcntFeed);

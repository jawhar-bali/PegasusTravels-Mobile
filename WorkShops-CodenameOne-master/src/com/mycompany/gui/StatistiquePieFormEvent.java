 ...
 * @author rahma
 */
public class StatistiquePieFormEvent extends Form {
    private boolean drawOnMutableImage;
   
   
    private double nbr_reservation = 0.4;
    private double nbr_voyage = 0.6;
   
    Form current;
     Form form;
        public StatistiquePieFormEvent(Resources res)  {
